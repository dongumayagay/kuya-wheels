...
<div id="dataPrivacyText">
    ...
    <h2>
        This Data Privacy Policy applies to Personal Information we collect on our website, kuya-wheels.vercel.app.
        <br>
        <br>
        We have prepared this Privacy Policy to help you understand how Kuya Wheels Driving School collects, uses, and seeks to safeguard the Personal Information (as defined below) you provide to us on our websites, via email, and through our service providers and distribution partners. This Privacy Policy does not address, and we are not responsible for, the privacy, information or other practices of any third party, including any third-party distribution partners, suppliers and tour operators, and any third party operating any site to which our websites contain a link. By downloading, accessing or using our websites, or providing information to us in connection with our websites, you agree to the terms and conditions of this Privacy Policy.
    </h2>
    <h1>
    ...
    <h2>
        ...
        <br>
        <br>
        When you visit Kuya Wheels Driving School.ph or any of our affiliates' web pages that are hosted by us, our web server automatically recognizes and collects your IP address, which is assigned by your Internet Service Provider and does not identify you personally.
        <br>
        <br>
    ...
    <h2>
        ...
        To measure and track demographic details about our customers;<br>
    ...
    <h2>
        In the Company discretion, we may amend, interpret, modify or withdraw any portion of this Data Privacy Policy at any time by posting updated contents on the relevant Site, and your continued use of our Sites and services constitutes your consent to those changes.
    </h2>
</div>  
